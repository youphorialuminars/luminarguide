...
export const metadata: Metadata = {
  ...
  description:
    "Luminar'sGuide helps students in grades 6–12 grow beyond the textbook — self-awareness, resilience, and practical life skills, guided by trained mentors and a shared view for parents, schools, and counselors.",
  openGraph: {
    title: "Luminar'sGuide — Development Beyond the Textbook",
...
export default function LandingPage() {
  return (
    <>
      ...
      {/* "Why Luminar'sGuide" — Vision, Mission, and the fuller Message to
